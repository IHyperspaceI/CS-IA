...
/**
 * Contains information for an event that was hosted by the team
 */
public class HostedEvent extends Event implements Serializable {
    /**
     * Default constructor
     */
    public HostedEvent() {
     ...
     */
    public HostedEvent(String title, String summary, LocalDate date, double duration, int difficulty, int participatingTeams) {
